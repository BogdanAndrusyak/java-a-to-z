            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-login">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="login-form" action="${pageContext.servletContext.contextPath}/user/login.do" method="post" role="form" style="display: block;">
                                ...
                                <form id="register-form" action="${pageContext.servletContext.contextPath}/user/register.do" method="post" role="form" style="display: none;">
                                    <div class="form-group">
