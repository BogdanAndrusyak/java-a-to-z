...
<body>
    <div class="center-block-main">
            <h2>Add your car</h2>
            <form:form commandName="carAddForm" action="${pageContext.servletContext.contextPath}/car/add.do" method="post" cssClass="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10 text-right">
                        <input type="submit" class="btn btn-success btn-my"/>
                    </div>
                </div>
            </form:form>
    </div>
