...
<body>
    <div class="center-block-main">
        ...
        <div class="text-right">
            <a href="${pageContext.servletContext.contextPath}/car/viewadd.do" class="btn btn-info" role="button">Add your car</a>
        </div>
                                ...
                                <div class="primary-column">
                                    ...
                                    <div class="m-rows">
                                        ...
                                        <div class="m-indent">
                                            ...
                                            &lt;%&ndash;<select class="e-form" id="marks" name="marka_id" data-field="brand"
                                                    data-placeholder="Brand">
                                    ...
                                    <div class="m-rows">
                                        ...
                                        <div class="m-indent">
                                            ...
                                            &lt;%&ndash;<select class="e-form" id="models" name="model_id" data-field="model"
                                                    data-placeholder="Model">
